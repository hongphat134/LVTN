<section class="section-hero home-section overlay inner-page bg-image" style="background-image: url({{ url('images/hero_1.jpg')}})" id="home-section">
	...
	<form action="{{route('search','#next')}}" class="search-jobs-form">				
		<div class="row mb-5">
		...
		<div class="row mb-5 advanced-search-form">
			...
			<div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
			<input name="number" type="number" min='1' max='99' class="form-control" placeholder="Số lượng tuyển dụng..." 
			value="{{ isset($search_info['number']) ? $search_info['number'] : ''}}">
			</div>
			<div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
