...
@section('content')
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-lg-12">
            <form id="update-job" action="{{route('updateJob',$news->id)}}" class="p-4 p-md-5 border rounded" method="post">
              {{csrf_field()}}
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="job-title" name="vacancy" placeholder="Nhập số lượng...." value="{{$news->soluong}}">
              </div>
             <!--  <div class="form-group">
              ...
              <div class="form-group">
                ...
                @foreach($degree_list as $degree)                      
                  <option {{ $degree->ten == $news->bangcap ?'selected':''}}>{{$degree->ten}}</option>
                @endforeach
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                @foreach($exp_list as $exp)                      
                  <option {{ ($exp->ten == $news->kinhnghiem)?'selected':''}}>{{$exp->ten}}</option>
                @endforeach
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                @foreach($salary_list as $salary)                      
                  <option {{ ($salary->ten == $news->mucluong)?'selected':''}}>{{$salary->ten}}</option>
                @endforeach
                </select>
              </div>
