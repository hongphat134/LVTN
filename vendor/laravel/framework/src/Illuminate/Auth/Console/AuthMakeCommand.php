...
class AuthMakeCommand extends Command
{
     ...
     */
    protected $views = [
        'pages/login.stub' => 'pages/login.blade.php',
        'pages/register.stub' => 'pages/register.blade.php',
        'pages/passwords/email.stub' => 'pages/passwords/email.blade.php',
        'pages/passwords/reset.stub' => 'pages/passwords/reset.blade.php',
